...
const AboutMe = () => {
    return (
        <section id="about"
            className="h-[100vh] w-full flex flex-col lg:flex-row lg:justify-between px-6 lg:px-[8%] py-8 lg:pt-[10%]"
        >
            <div className="w-[80%] h-[30%] lg:h-[90%] mx-auto mb-8">
            ...
            <div className="mb-4 flex flex-col gap-4">
                <p className=" text-2xl mb-4 lg:mb-0"><span className="font-bold text-[#DC143C]">-</span>About Me</p>
                <h3 className="text-[2.5em] lg:text-4xl font-bold leading-tight ">Who is Benedicta <br></br> Davour?</h3>
                <p>
                ...
                <div className="flex justify-between items-center mb-8 lg:mb-2 lg:w-[50%]">
                    <div>
