...
const Footer = () => {
    return (
        <section id="footer-section" className="h-[30vh] bg-[black]">
            <div className="h-[80%] w-[80%] ml-[10%] flex justify-between align-center">
                ...
                <a href="#contact-section"><button className="mr-16 mt-[0.5em] h-[3em] w-[8em] rounded-sm bg-[white] font-medium ">Hire Me</button></a>
