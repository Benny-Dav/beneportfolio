...
const Navbar = () => {
    return (
        <div id="Navbar" className="h-[10%] flex justify-between p-4 border shadow-md bg-[white] fixed top-0 left-0 right-0 z-10">
            <a href="../components/Header.jsx"><h1 className="w-[7%] mr-[5%] text-[1.2em] font-extrabold">ami.</h1></a>
            <ul id="nav-ul" className="flex justify-between align-center w-[30%] font-bold">

                <li><a href="/">Home</a></li>
                <li><a href="../components/WebDevInfo.jsx">About</a></li>
                <li><a href="../components/Skills.jsx">Skills</a></li>
                <li><a href="../components/Portfolio.jsx">Portfolio</a></li>
                <li><a href="../components/Footer.jsx">Contacts</a></li>

            </ul>
            <ul id="nav-icons" className="flex justify-between align-center gap-[5%] w-[20%] ">
